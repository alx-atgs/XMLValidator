 ...
 * LogApp.isOwnconsole(true or false) - вывод только в лог (false) или также на
 * консоль (true), по-умолчанию false.
 * 
...
public class LogApp {
	...
	public static void LogAppSetting(String pathLogFile, String logFormat, boolean ownconsole) {
		...
		try {
			fh = new FileHandler(getPathLogFile(), false);
	...
	public static void info(String MessageTxt) {
		...
		LogAppSetting(getPathLogFile(), getLogFormat(), isOwnconsole());
